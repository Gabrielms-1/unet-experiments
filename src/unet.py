...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        print(f"Shape da saída do conv_block (d4): {d4.shape}")
        d4 = self.deconv4(d4)
        ...
        print(f"Shape da saída do conv_block (d3): {d3.shape}")
        d3 = self.deconv3(d3)
        ...
        print(f"Shape da saída do conv_block (d2): {d2.shape}")
        d2 = self.deconv2(d2)
        ...
        print(f"Shape da saída do conv_block (d1): {d1.shape}")
        d1 = self.deconv1(d1)
